        ...
        <div className="container-app section-padding relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="hero-subtitle text-lg sm:text-xl text-gray-600 mb-8 max-w-lg">
              Panadería Maná - Horneando tradición con los mejores ingredientes locales. 
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link
                to="/nosotros"
                className="hero-cta btn-secondary inline-flex items-center gap-2"
              >
                Conocer Más
              </Link>
            </div>
            ...
            <div className="mt-12 flex flex-wrap gap-6 sm:gap-10">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-mana-green/10 rounded-xl flex items-center justify-center">
                  <Clock className="w-6 h-6 text-mana-green" />
                </div>
                <div>
                  <p className="text-sm text-gray-500">Horario</p>
                  <p className="font-medium text-gray-900">Lun-Sáb 6:00-20:00</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-mana-burgundy/10 rounded-xl flex items-center justify-center">
                  <MapPin className="w-6 h-6 text-mana-burgundy" />
                </div>
                <div>
                  <p className="text-sm text-gray-500">Ubicación</p>
                  <p className="font-medium text-gray-900">Av. Lavalle 1234</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container-app section-padding">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Los productos más amados por nuestros clientes
              </p>
            </div>
            <Link
              to="/productos"
              className="inline-flex items-center gap-2 text-mana-green font-medium hover:text-mana-burgundy transition-colors"
            >
              Ver todos
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredProducts.map((product) => (
              <div
                key={product.id}
                className="featured-card product-card-3d bg-white rounded-2xl overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300"
              >
                <div className="relative aspect-square overflow-hidden">
                  ...
                  <button
                    ...
                    className="absolute bottom-3 right-3 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center text-mana-green hover:bg-mana-green hover:text-white transition-colors"
                  >
        ...
        <div className="container-app section-padding">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-2 max-w-xl mx-auto">
              Encuentra exactamente lo que buscas en nuestra variedad de productos artesanales
            </p>
          </div>
            ...
            {categories.slice(0, 6).map((category, index) => {
              ...
              return (
                <Link
                  ...
                  className={`category-card group relative overflow-hidden rounded-2xl aspect-[4/3] ${
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6">
                    <h3 className="font-heading text-2xl sm:text-3xl font-bold text-center">
                      {categoryLabels[category]}
                    </h3>
                    <span className="mt-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      Explorar
                    </span>
                  </div>
                </Link>
        ...
        <div className="container-app section-padding">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="about-image relative">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white rounded-xl shadow-xl p-6">
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <p className="font-heading text-2xl sm:text-3xl font-bold text-mana-green">38+</p>
                    <p className="text-xs sm:text-sm text-gray-500">Años de trayectoria</p>
                  </div>
                  <div>
                    <p className="font-heading text-2xl sm:text-3xl font-bold text-mana-burgundy">50+</p>
                    <p className="text-xs sm:text-sm text-gray-500">Productos artesanales</p>
                  </div>
                  <div>
                    <p className="font-heading text-2xl sm:text-3xl font-bold text-mana-green">1000+</p>
                    <p className="text-xs sm:text-sm text-gray-500">Clientes felices</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="about-content">
              ...
              <h2 className="font-heading text-3xl sm:text-4xl font-bold text-gray-900 mt-2">
                Más de 38 años de tradición
              </h2>
              <p className="text-gray-600 mt-4 leading-relaxed">
                Desde 1985, en el corazón de Posadas, Misiones, la familia Maná ha mantenido 
                viva la tradición de la panadería artesanal. Cada madrugada, nuestros maestros 
                panaderos combinan técnicas ancestrales con los mejores ingredientes locales 
                para crear productos que no solo alimentan, sino que cuentan historias.
              </p>
              <p className="text-gray-600 mt-4 leading-relaxed">
                Nuestro compromiso es simple: ofrecer productos frescos, elaborados con amor 
                y dedicación, manteniendo vivas las recetas que han pasado de generación en 
                generación.
              </p>
              
              <div className="mt-8 flex flex-wrap gap-4">
                <Link to="/nosotros" className="btn-primary inline-flex items-center gap-2">
          ...
          <div className="relative bg-mana-burgundy rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 px-8 py-16 sm:px-16 sm:py-20 text-center">
              ...
              <p className="text-white/80 text-lg max-w-2xl mx-auto mb-8">
                Haz tu pedido ahora y recoge en tienda, o disfruta de nuestro servicio 
                a domicilio en Posadas.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Link
                  to="/productos"
                  className="px-8 py-4 bg-white text-mana-burgundy rounded-xl font-semibold hover:bg-mana-cream transition-colors inline-flex items-center gap-2"
                >
                  Hacer Pedido
                  <ArrowRight className="w-5 h-5" />
                </Link>
